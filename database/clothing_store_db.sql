...
INSERT INTO `categories` (`id`, `typeId`, `name`)
VALUES (1, 1, 'Nam'),
       (2, 1, 'Nữ'),
       (3, 1, 'Trẻ em'),
       (4, 2, 'Nam'),
...
INSERT INTO `coupons` (`id`, `code`, `remainingCount`, `discount`, `decription`)
VALUES (1, 'abc', 10, 0.2, 'Ưu đãi, giảm giá đặc biệt');
...
INSERT INTO `payments` (`id`, `paymentMethod`)
VALUES (1, 'Cash on delivery'),
       (2, 'Online payment');
...
INSERT INTO `products` (`id`, `typeId`, `categoryId`, `supplierId`, `productName`, `description`, `releaseDate`,
                        `unitSold`, `unitPrice`, `status`)
VALUES (1, 2, 4, 1, 'Quần tây PEALO form cạp cao có xếp li', 'Quần đùi xà lỏn của nhân dón mặc', '2024-12-15', 50,
        274550.00, b'1'),
       (2, 2, 4, 1, 'Quần kaki ống suông nam PEALO',
        'Mô tả sản phẩm: Quần kaki ống suông nam PEALO casual pants trơn basic chất liệu mới Loose Pants phong cách Minimalism Menswear... (Rút gọn nếu cần)',
        '2024-12-17', 40, 280000.00, b'1'),
       (3, 2, 4, 2, 'Quần tây quần vải cạp ống rộng',
        'Quần tây quần vải cạp ống rộng - B Brown Wide Fit Trousers... (Rút gọn nếu cần)', '2024-10-14', 100, 470000.00,
        b'1'),
       (4, 2, 4, 3, 'Quần Dài Ống Rộng Hàn Quốc Hàng Cao Cấp',
        'Tên sản phẩm: Quần Dài Ống Rộng Hàn Quốc Hàng Cao Cấp BBrand... (Rút gọn nếu cần)', '2024-11-19', 80,
        490000.00, b'1'),
       (5, 2, 4, 4, 'QUẦN DÁNG XUÔNG XẾP LY BY RUYCH.', 'Size: M, L, XL...\r\n... (Rút gọn nếu cần)', '2024-10-07', 110,
        369000.00, b'1');
...
INSERT INTO `product_details` (`id`, `productId`, `size`, `stock`, `image`, `color`)
VALUES (1, 1, 'M', 10, 'p1n1.webp', 'Nâu dạ'),
...
INSERT INTO `suppliers` (`id`, `supplierName`, `supplierImg`)
VALUES (1, 'PEALO', ''),
       (2, 'B Brown Studio', ''),
       (3, 'BBRAND', ''),
       (4, 'RUYCH STUDIO', '');
...
INSERT INTO `users` (`id`, `userName`, `password`, `firstName`, `lastName`, `email`, `avatar`, `address`, `phone`,
                     `status`, `createdAt`, `roleId`)
VALUES (1, 'admin', 'admin', 'Mạnh', 'Hoàng Lê Nguyên', 'admin@gmail.com', 'anhday', 'DakNong', '099999999', b'1',
        '2024-12-24 22:34:35', 1),
       (2, 'user1', 'user1', 'Luật', 'Hoàng Quốc', 'luatday@gmail.com', 'luatday', 'SaiGon', '011111111', b'1',
        '2024-12-24 22:35:54', 2),
       (3, 'user2', 'user2', 'Nam', 'Phạm Quốc Phương', 'namday@gmai.com', 'namday', 'SaiGon', '022222222', b'1',
        '2024-12-24 22:37:22', 2);
