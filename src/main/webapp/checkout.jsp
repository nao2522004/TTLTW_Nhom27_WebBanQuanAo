                ...
                <div class="col-md-4 order-md-2 mb-4">
                    ...
                    <ul class="list-group mb-3">
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            <div>
                                <h6 class="my-0 gr-text">Áo Thun</h6>
                                <small class="text-muted">Số lượng: 1</small>
                            </div>
                            <span class="text-muted">100.000 đồng</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            <div>
                                <h6 class="my-0 gr-text">Áo Thun</h6>
                        ...
                        <li class="list-group-item d-flex justify-content-between bg-light">
                            ...
                            <span class="text-success" style=" color: #335d4a !important">+30.000 đồng</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between bg-light">
                            <div class="text-success">
                                <h6 class="my-0 gr-text text-custom">Mã Giảm Giá</h6>
                            </div>
                            <span class="text-success" style=" color: #335d4a !important">-20.000 đồng</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between">
                            <span class="my-0 gr-text">Tổng Tiền</span>
                            <strong>310.000 đồng</strong>
                        </li>
                    </ul>
                </div>
                <div class="col-md-8 order-md-1">
                    ...
                    <form class="needs-validation" novalidate>
                        ...
                        <div class="md-6 mb-3">
                            ...
                            <select class="custom-select d-block w-100 large-select" id="paymentMethod" name="paymentMethod" required>
