    ...
    <div class="row">
      ...
      <div class="col-md-3 bg-light p-0 sidebar">
        <ul class="list-group list-group-flush">
          ...
          <li class="nav-item" onclick="showMain(event, 'order-container')"><i class="fas fa-history"></i> Lịch sử đơn
            hàng</li>
          <li class="nav-item" onclick="showMain(event, 'voucher-wallet')"><i class="fas fa-wallet"></i> Ví Voucher</li>
          <li class="nav-item" onclick="showMain(event, 'order-feedback')"><i class="fas fa-star"></i> Đánh giá và phản
            hồi</li>
