...
<body style="background-color: #f4f4f4; font-family: Arial, sans-serif; margin: 0; padding: 20px;">
    ...
    <section style="margin-top: 50px; text-align: center;">
        ...
        <c:if test="${transResult}">
            <div>
                ...
                <p style="font-size: 18px; margin-top: 15px;">Liên hệ số điện thoại của nhân viên tư vấn:</p>
                <strong style="color: red; font-size: 24px;">0933459xxx</strong>
            </div>
        </c:if>
        ...
        <c:if test="${transResult == false}">
            <div>
                ...
                <p style="font-size: 18px;">Liên hệ số điện thoại của nhân viên tư vấn:</p>
                <strong style="color: red; font-size: 24px;">0933459xxx</strong>
            </div>
        </c:if>
    ...
    <div style="margin-top: 40px; text-align: center;">
        <a href="homePage" class="return-home">Trở về trang chủ</a>
    </div>
</body>
</html>
