...
//    }
    ...
    public List<Product> getAllProducts() {
        ...
        return getProductsByQuery(query, query2);
    }
    ...
    public List<Product> getProductsByQuery(String... queries) {
        List<Product> list = new ArrayList<>();
        return conn.get().withHandle(h -> {
           try (PreparedStatement stmt = h.getConnection().prepareStatement(queries[0]);
               ...
               while(rs.next()) {
                   ...
                   try (PreparedStatement stmt2 = h.getConnection().prepareStatement(queries[1])) {
